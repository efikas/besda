...
class SidebarFormFieldEditItem extends React.Component {
	...
	/**
	 * Component will update the state using store
	 * @param nextProps
	 */
	componentWillReceiveProps(nextProps) {
		if (nextProps.formFieldEditor.activeFormField !== this.state.index) {
			this.setState({ index: nextProps.formFieldEditor.activeFormField });
		}
	}
