					...
					<?php if($image_link_url) { 
						if($image_type == 'image') { 
							...
							<a href="<?php echo $image_link_url; ?>" title="<?php echo $title; ?>" target="<?php echo $url_target; ?>">
								<div data-category="<?php echo $filter_keys; ?>" data-sort="<?php echo $title; ?>" class="animateonload filtr-item filtr_item_<?php echo $pf_gallery_id; ?> single_one <?php echo $col_large_desktops; ?> <?php echo $col_desktops; ?> <?php echo $col_tablets; ?> <?php echo $col_phones; ?>">
